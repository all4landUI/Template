	...
	<div class="window_content">
		...
		<div class="tab-content">
			<div class="tab-panel active" data-panel="tab_example1">
				...
				그렇게 설계된 내용을 디자이너와 개발자에게 전달하면 디자이너와 개발자는 그에 맞게 작업을 진행하게 됩니다. 그 과정에서 기획자는 초기 디자인 컨셉, 홈페이지 기능, 클라이언트가 원하는 방향 등을 디자이너와 개발자에게 끊임없이 인식시켜주는 역할을 해야합니다. 그렇지 않으면 초기의 기획 방향과 다른 방향으로 흘러갈 수 있기 때문입니다.<br><br>
