	...
	<article class="container">
        ...
        <section id="content" class="content">
                ...
                <table>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>국토정보플랫폼</td>
                            <td class="subject"><a href="PB_SC_282.php">웨서비스 개선(공모) 결과</a></td>
                            <td>국토측량과</td>
                            <td><span class="txt-gray">2015.07.30</span></td>
                            <td><span class="has-file">첨부파일 있음</span></td>
                            <td><span class="txt-gray">10</span></td>
                        ...
                        <tr>
                            ...
                            <td>극지공간정보</td>
                            <td class="subject"><a href="PB_SC_282.php">시스템 점검 및 모니터링 안내</a></td>
            ...
            <div class="bt-area text-right">
                <button type="button" onclick="location.href='PB_SC_283.php'" class="bt submit">등록</button>
            </div>
        </section>
        <!-- /Contents -->
