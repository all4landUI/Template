	...
	<article class="container">
        ...
        <section id="lnb" class="lnb">
            ...
            <ul role="menu">
                ...
                <li class="current"><a href="PB_SC_285.php">Q&amp;A</a></li>
        ...
        <section id="content" class="content">
            ...
            <div class="bt-area text-right">
                ...
                <button type="button" onclick="location.href='PB_SC_287.php'" class="bt reset">답글</button>
                <button type="button" onclick="location.href='PB_SC_285.php'" class="bt list">목록</button>
            </div>
        </section>
        <!-- /Contents -->
