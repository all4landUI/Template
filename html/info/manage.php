                ...
                <table>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><input type="text" id="e-scale" name="" value="" class="full" placeholder="예) 100m x 100m"></td>
                        </tr>
                        <tr>
                ...
                <table>
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td><input type="file" id="e-file-upload3" name="" value=""></td>
                        </tr>
                        <tr>    
                            <th scope="row"><label for="e-file-upload4">4방위(남쪽)</label></th>
                            <td><input type="file" id="e-file-upload4" name="" value=""></td>
                            <th scope="row"><label for="e-file-upload5">4방위(북쪽)</label></th>
                            <td><input type="file" id="e-file-upload5" name="" value=""></td>
                        </tr>
                        <tr>
                            <th scope="row"><label for="e-file-upload6">대표 지형·지질·경관 이름</label></th>
                            <td><input type="file" id="e-file-upload6" name="" value=""></td>
                            <th scope="row"><label for="e-file-upload7">대표 지형·지질·경관 이름</label></th>
                            <td><input type="file" id="e-file-upload7" name="" value=""></td>
                        </tr>
                        <tr>
                            <th scope="row"><label for="e-file-upload8">대표 지형·지질·경관 이름</label></th>
                            <td><input type="file" id="e-file-upload8" name="" value=""></td>
                            <th scope="row"><label for="e-file-upload9">대표 지형·지질·경관 이름</label></th>
                            <td><input type="file" id="e-file-upload9" name="" value=""></td>
                        </tr>
                    </tbody>
                </table>
                </div>
